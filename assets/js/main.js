...
document.write('            <p style="font-size:20px; ">Chào Mừng Bạn Đã Ghé Trang Web Của Tôi <a href="https://www.facebook.com/profile.php?id=100038972713516" target="_blank"  style=" color:blue; font-weight: bold;"> Phạm Ngọc vũ</a></p><br>');
document.write('            <p style="font-size:20px; ">🔥Website Được Tạo Bởi<a href="https://zalo.me/0385998065" target="_blank"  style=" color:blue; font-weight: bold;"> Phạm Ngọc Vũ</a></p>');
document.write('            </div>');
document.write('    </div>');
document.write('    ');
