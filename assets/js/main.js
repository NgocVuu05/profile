...
document.write('            <p style="font-size:20px; ">Chào Mừng Bạn Đã Ghé Trang Web Của Tôi <a href="https://dinhduyvinh.dev" target="_blank"  style=" color:blue; font-weight: bold;"> DinhDuyVinh.Dev</a></p><br>');
document.write('            <p style="font-size:20px; ">🔥Website Được Tạo Bởi<a href="https://zalo.me/duyvinh09" target="_blank"  style=" color:blue; font-weight: bold;"> Phạm Ngọc Vũ</a></p>');
document.write('            </div>');
document.write('    </div>');
document.write('    ');
